CREATE OR REPLACE FUNCTION cf_summary_data(_as_of date)
    RETURNS TABLE
            (
...
BEGIN
    ...
    WITH h AS (
        ...
        WHERE
          --o.deleted_at IS NULL -- limiting to active accounts
            o.organization_type_id = 300 -- ost
...
ALTER FUNCTION cf_summary_data(date) OWNER TO main;
